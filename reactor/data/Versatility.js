const Versatility =
    ...
    [{
        ...
        title: "Start",
        hideNameOnGrid: true,
        description: "• With the dog <b>heeling on the right</b>, the <b>team heels past the Start station.</b><br/> • Timing begins.<br/> • There are no other commands from the Judge throughout the course.<br/><br/>",
  ...
  },
  {
        ...
        category: "Versatility",
        title: "Finish",
        description: "• With the dog <b>heeling on the right</b>, the <b>team heels past the Finish station.</b><br/> • Timing ends.<br/><br/>",
   ...
   },
  {
        ...
        category: "Versatility",
        title: "400. Turn In",
        description: "• The dog and handler <b>simultaneously turn in towards each other and resume heeling with the dog on the opposite side of the handler.</b><br/>• This station will result in a 180-degree change of direction and a change of side.<br/><br/>",
        ...
        deductions: {
          minor: ["Out of heel position", "Loss of forward motion", "Dog interfering with handler"],
          nq: ["Dog and handler do not turn in towards one another or do not turn in at the same time","Change of heeling side does not occur"], },
        video: undefined,
        },{
        ...
        category: "Versatility",
        title: "401. Turn Away",
        description: "• The dog and handler <b>simultaneously turn away from each other and resume heeling with the dog on the opposite side of the handler</b>.<br/>• This station will result in a 180-degree change of direction and a change of side.<br/><br/>",
        tips: "• Change of side signs are always orange, regardless of whether the team approaches the sign with dog heeling on the left or right. Which side the dog is on when the station is initiated is determined by the previous sign. By performing the change of side exercise, the dog will end up on the opposite side and will proceed to the next sign on the new side.",
        deductions: {
          minor: ["Out of heel position", "Loss of forward motion", "Dog interfering with handler"],
          nq: ["Dog and handler do not turn away from one another or do not turn away at the same time","Change of heeling side does not occur"], },
        video: undefined,
        },{
        ...
        description: "• The dog and handler <b>simultaneously</b> perform <b>parallel right turns</b> and <b>resume heeling with the dog on the opposite side of the handler.</b><br>• This station will result in a 180-degree change of direction and a change of side.<br/><br/>",
        tips: "• Change of side signs are always orange, regardless of whether the team approaches the sign with dog heeling on the left or right. Which side the dog is on when the station is initiated is determined by the previous sign. By performing the change of side exercise, the dog will end up on the opposite side and will proceed to the next sign on the new side.",
        deductions: {
          minor: ["Out of heel position", "Loss of forward motion", "Dog interfering with handler"],
          nq: ["Dog and handler do not make parallel right turns or do not do so at the same time","Change of heeling side does not occur"], },
        video: undefined,
        },{
        ...
        description: "• The dog and handler <b>simultaneously</b> perform <b>parallel left turns</b> and <b>resume heeling with the dog on the opposite side of the handler.</b><br>• This station will result in a 180-degree change of direction and a change of side.<br/><br/>",
        tips: "• Change of side signs are always orange, regardless of whether the team approaches the sign with dog heeling on the left or right. Which side the dog is on when the station is initiated is determined by the previous sign. By performing the change of side exercise, the dog will end up on the opposite side and will proceed to the next sign on the new side.",
        deductions: {
          minor: ["Out of heel position", "Loss of forward motion", "Dog interfering with handler"],
          nq: ["Dog and handler do not make parallel left turns or do not do so at the same time","Change of heeling side does not occur"], },
        video: undefined,
        },{
        ...
        description: "• While heeling forward, the handler cues the <b>dog to cross in front</b> and <b>resume heeling with the dog on the opposite side of the handler.</b><br/>• This station will result in a change of side.<br/><br/>",
        ...
        deductions: {
          minor: ["Out of heel position (except during the cross)", "Loss of forward motion (brief pause allowed during cross)", "Dog interfering with handler"],
          nq: ["Dog does not change heeling sides by crossing in front of the handler"], },
        video: undefined,
        },{
        ...
        description: "• While heeling forward, the handler cues the <b>dog to cross behind</b> and <b>resume heeling with the dog on the opposite side of the handler.</b><br/>• This station will result in a change of side.<br/><br/>",
        tips: "• You are permitted to pause (briefly stop forward motion) for the dog to cross in front of you.<br/>• Change of side signs are always orange, regardless of whether the team approaches the sign with dog heeling on the left or right. Which side the dog is on when the station is initiated is determined by the previous sign. By performing the change of side exercise, the dog will end up on the opposite side and will proceed to the next sign on the new side.",
        deductions: {
          minor: ["Out of heel position (except during the cross)", "Loss of forward motion (brief pause allowed during cross)", "Dog interfering with handler"],
          nq: ["Dog does not change heeling sides by crossing behind the handler"], },
        video: undefined,
        },{
        ...
        description: "• While heeling forward, the handler cues the <b>dog to weave through their legs to change sides.</b><br/><br/>",
        ...
        deductions: {
          minor: ["Out of heel position (except during the cross)", "Loss of forward motion (brief pause allowed during cross)", "Dog interfering with handler"],
          nq: ["Dog does not change heeling sides by crossing between the handler's legs"], },
        video: undefined,
        },{
        ...
        description: "• While heeling with the dog on the left, the <b>dog spins in a circle in place to the left</b><br/>• The <b>handler turns right</b> and cues the <b>dog to cross behind</b> and <b>resume heeling with the dog on the right side of the handler.</b><br/>• The handler may pause while the dog completes the spin.<br/>• This station results in a 90-degree change of direction to the right and a change of side from left to right.<br/><br/>",
        tips: "• The handler may come to a complete stop (briefly) while the dog spins.",
        deductions: {
          minor: ["Dog out of heel position", "Initiation of signs outside of a radius of two feet from the station sign"],
          nq: ["Dog does not spin to the left", "Dog performs a behaviour not required for the sign, such as a sit or spin right", "Handler does not turn right", "Dog does not cross behind the handler to heel on the right side"], },
        video: undefined,
        },{
        ...
        description: "• While heeling with the dog on the right</b>, the <b>dog spins in a circle in place to the right</b><br/>• The <b>handler turns left</b> and cues the <b>dog to cross behind</b> and <b>resume heeling with the dog on the left side of the handler.</b><br/>• The handler may pause while the dog completes the spin.<br/>• This station results in a 90-degree change of direction to the right and a change of side from left to left.<br/><br/>",
        tips: "• The handler may come to a complete stop (briefly) while the dog spins.",
        deductions: {
          minor: ["Dog out of heel position", "Initiation of signs outside of a radius of two feet from the station sign"],
          nq: ["Dog does not spin to the right", "Dog performs a behaviour not required for the sign, such as a sit or spin left", "Handler does not turn left", "Dog does not cross behind the handler to heel on the left side"], },
        video: undefined,
        },{
        ...
        description: "• While <b>heeling with the dog on the right</b>, the team comes to a <b>halt</b> and the handler cues the dog to <b>sit in heel position.</b><br/> • The handler cues the dog to <b>stand</b>.<br/>• The handler cues the dog to <b>heel forward from the stand position</b>.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
        ...
        category: "Versatility",
        title: "410. HALT - Down",
        description: "• While <b>heeling with the dog on the right</b>, the team comes to a <b>halt</b> and the handler cues the dog to <b>sit in heel position.</b><br/> • The handler cues the dog to <b>down</b>.<br/> • The handler cues the dog to <b>heel forward from the down position</b>.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
        ...
        description: "• While <b>heeling with the dog on the right</b>, the team comes to a <b>halt</b> and the handler cues the dog to <b>sit in heel position.</b><br/> • The handler cues the dog to <b>down</b>.<br/> • The handler cues the dog to <b>sit</b>.<br/> • The handler cues the dog to <b>heel forward from the sit position</b>.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
            "Dog sits or downs more than 45-degrees out of heel position",
        ...
        description: "• While <b>heeling with the dog on the right</b>, the team <b>makes a 90-degree turn to the right.</b><br/>• This station results in a 90-degree change of direction to the right.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
            "Initiation of the sign outside of a radius of two feet from the station sign",
        ...
        category: "Versatility",
        title: "420. Left Turn",
        description: "• While <b>heeling with the dog on the right</b>, the team <b>makes a 90-degree turn to the left.</b><br/>• This station results in a 90-degree change of direction to the left.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
            "Initiation of the sign outside of a radius of two feet from the station sign",
        ...
        category: "Versatility",
        title: "423. 270 Right",
        description: "• While <b>heeling with the dog on the right</b>, the team <b>makes a 270-degree turn to the right.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/>• This station results in a 90-degree change of direction to the left.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
        ...
        category: "Versatility",
        title: "424. 270 Left",
        description: "• While <b>heeling with the dog on the right</b>, the team <b>makes a 270-degree turn to the left.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/>• This station results in a 90-degree change of direction to the right.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
            "Handler's path while turing more than a 2-foot radius",
        ...
        category: "Versatility",
        title: "425. 360 Right",
        description: "• While <b>heeling with the dog on the right</b>, the team <b>makes a 360-degree turn to the right.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/><br/>,",
        tips: "",
        deductions: {
          minor: [
            "Handler's path while turning more than a 2-foot radius",
        ...
        category: "Versatility",
        title: "426. 360 Left",
        description: "• While <b>heeling with the dog on the right</b>, the team <b>makes a 360-degree turn to the left.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/><br/>",
        tips: "",
        deductions: {
          minor: [
            "Handler's path while turning more than a 2-foot radius",
        ...
        category: "Versatility",
        title: "427. Slow",
        description: "• While <b>heeling with the dog on the right</b>, the team decreases its pace so that there is a <b>noticeable difference in the dogs’ speed from the normal pace.<br/>• The slow pace is maintained continuously until the next station.</b><br/>• This station is followed by either Fast, Normal or the Finish station.</br><br/>",
        tips: "",
        deductions: {
      ...
      nq: [
        ...
        category: "Versatility",
        title: "429. Normal",
        description: "• While <b>heeling with the dog on the right</b>, the team moves forward at a <b>normal pace</b> that is comfortable for the dog and handler.<br/>• There must be a <b>noticeable difference in the dogs’ speed from the slow or fast to normal pace.</b><br/><br/>",
        tips: "",
        deductions: {
          minor: ["Dog is out of heel position. Forging (mid-point of the dog’s body is past the handler's side), Wide (dog is more than an arm’s length away from the handler's side) or Lagging (dog’s nose drops behind the handler’s side)"],
      nq: ["No noticeable change in the dog's pace from the slow or fast pace to normal pace"], },
        ...
        description: "• While <b>heeling with the dog on the right, the team enters the pattern with the first cone on the team’s left</b>.<br/>• The team <b>weaves through the cones</b> and exits the station.<br/><br/>",
        tips: "",
        deductions: {
          minor: [        
            "Handler or dog stop forward motion", 
        ...
        description: "• While <b>heeling with the dog on the right, the team enters the pattern with the first cone on the team’s left</b>.<br/>• The team <b>weaves continuously through the cones, loops around the end cone and weaves back to the beginning of the pattern</b>.<br/><br/>",
        tips: "",
        deductions: {
          minor: [        
            "Handler or dog stop forward motion", 
      ...
      nq: [
        ...
        description: "• While <b>heeling with the dog on the right</b>, the team <b>enters the weave poles with the first pole on the team’s left</b>.<br/>• The dog <b>weaves through the poles</b> and exits the station.<br/>• For this station to be considered complete, <b>the dog must weave through all the poles in the correct pattern</b>.<br/><br/>",
