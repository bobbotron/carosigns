  ...
  },
  {
    ...
    levels: {
      ...
      elite: {
        ...
        layout: "",
        layoutImages: [require("../assets/Diagrams/ROF_allLevels.JPG")],
        passRequirements: ["The dog sits in heel position until cued,", "Maintains sitting in heel position while the handler throws the object at least 10ft and it has stopped moving,", "Retrieves the object on cue,","Returns to the handler to sit in front position,","Remains sitting in front position while the handler takes the object directly from the dog."],
      },
      expert: {
...

  {
    ...
    levels: {
      rookie: {
        ...
        passRequirements: ["The dog sits in heel position until cued,", "Circles the cones in the correct order and direction as illustrated below,","Returns to the handler to sit in front position."],
      },
      elite: {
        procedure: "The exercise begins when the handler steps into the handler box.<br/><br/>• The handler cues the dog to sit in heel position,<br/>• Sends the dog through one of the two possible patterns as depicted below,<br/>• Calls the dog to sit in front position.<br/><br/>The exercise ends when the dog sits in front position.<br/><br/><br/>",
        procedureImages: [require("../assets/Diagrams/BR_Layout.JPG")],
      ...
      expert: {
        ...
        passRequirements: ["The dog sits in heel position until cued,", "Circles the cones in the correct order and direction as illustrated below,","Returns to the handler to sit in front position,","Finishes on cue."],
      },
    },
  },
 ...
 },
  {
    ...
    levels: {
      ...
      expert: {
        ...
        procedureImages: [],
        layout: "The dog box is 15 feet total away from the handler box or handler line.", "A sit is performed at a 5ft line (two cones may be used in place of a line)",
