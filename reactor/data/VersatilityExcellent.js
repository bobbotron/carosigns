const VersatilityExcellent =
    ...
    [{
        ...
        description: "• While heeling, the handler cues the <b>dog to sit and without pausing continues forward.<br/>• The dog must hold the sit until called.<br/>• After the handler has completely passed over the 5-foot line and while continuing to walk</b>, the handler <b>calls the dog to heel on the opposite side</b> and the team continues to the next station.<br/><br/>",
        tips: ".",
        deductions: {
        minor: [
        "Crooked sit (45 to 90 degrees)",
      ],
        substantial: ["Handler significantly slows their pace on moving position change exercises","Failure of the dog to assume the requested position promptly"],
        nq: ["Handler stops forward motion to perform moving position exercises", "Handler calls the dog before crossing the 5-foot line", "Dog does not sit or does not hold the sit until called","Dog does not cross sides", "Sit crooked by more than 90 degrees"]
       },
  },
  {
        name: "501",
        ...
        description: "• While heeling, the handler cues the <b>dog to stand and without pausing continues forward.<br/>• The dog must hold the stand until called.<br/>• After the handler has completely passed over the 5-foot line and while continuing to walk</b>, the handler <b>calls the dog to heel on the opposite side</b> and the team continues to the next station.<br/><br/>",
        tips: ".",
        deductions: {
            minor: [
            "Crooked stand (45 to 90 degrees)",
          ],
            substantial: ["Handler significantly slows their pace on moving position change exercises","Failure of the dog to assume the requested position promptly"],
            nq: ["Handler stops forward motion to perform moving position exercises", "Handler calls the dog before crossing the 5-foot line", "Dog does not stand or does not hold the stand until called","Dog does not cross sides", "Stand crooked by more than 90 degrees"]
           },
      },
      {
        name: "502",
        ...
        description: "• While heeling, the handler cues the <b>dog to down and without pausing continues forward.<br/>• The dog must hold the down until called.<br/>• After the handler has completely passed over the 5-foot line and while continuing to walk</b>, the handler <b>calls the dog to heel on the opposite side</b> and the team continues to the next station.<br/><br/>",
        tips: ".",
        deductions: {
            minor: [
            "Crooked down (45 to 90 degrees)",
          ],
            substantial: ["Handler significantly slows their pace on moving position change exercises","Failure of the dog to assume the requested position promptly"],
            nq: ["Handler stops forward motion to perform moving position exercises", "Handler calls the dog before crossing the 5-foot line", "Dog does not down or does not hold the down until called","Dog does not cross sides", "Down crooked by more than 90 degrees"]
           },
      },
      {
        name: "503",
        ...
        description: "• With the dog <b>heeling on the right</b>, the team comes to a <b>halt</b> and <b>the dog sits in heel position.</b><br/>• The handler cues the dog to heel and moves <b> immediately into a fast pace from the halt</b>.<br/>• This station is followed by either Slow, Normal or the Finish station.<br/><br/>",
  ...
  },
  {
    ...
    },
    {
        ...
        description: "• With the <b>dog heeling on the right</b>, the <b>dog spins in a circle in place to the right</b> beside the handler.<br/>• The handler may pause briefly as needed.<br/><br/>",
  ...
  },
  {
        ...
        description: "• With the <b>dog heeling on the right</b>, the <b>handler turns left</b>.<br/>• Simultaneously the <b>dog circles around the handler to the right returning to heel position</b>.<br/>• The handler may briefly pause to allow the dog to cross their path.<br/>• The team will be back in heel position as they face the new direction.<br/>• This sign results in a 90-degree change of direction to the left.<br/><br/>",
    ...
    deductions: {
      ...
      nq: ["The team does not make a 90-degree turn to the left", "The dog does not circle the handler and in the correct direction", "The dog does not return to the right side", "The dog assumes a position not required by the exercise (eg. a sit)"],
    },
  },
  {
        name: "510",
        ...
        description: "• With the <b>dog heeling on the right</b>, the <b>handler performs a 180-degree right turn</b>, while the <b>dog simultaneously performance a 180-degree left turn moving around the handler</b>.<br/>• The team will be back in heel position as they face the new direction.<br/>• This station results in a 180-degree change of direction.<br/><br/>",
  ...
  },
  {
    ...
    tips: "• This sign is typically executed by using the heel of the <i>right</i> foot as a pivot point, pivoting 180-degrees to the right, and then bringing the left foot into alignment with the right.<br/>",
      ...
      nq: ["Handler takes a step rather than a pivot","Dog does not move simultaneously with the handler", "Failure of the dog to sit at both halts", "Dog assumes a position not required by the exercise", "Dog sits 90-degrees or more out of heel position"],
    },
  },
  {
        name: "512",
  ...
  },
  {
        ...
        description: "• With the <b>dog heeling on the right</b>, the team comes to a <b>halt</b> and the dog <b>sits in heel position</b>.<br/>• The handler cues the dog to heel, <b>turns 180 degrees to their right</b> and heels forward.<br/>• This station results in a 180-degree change of direction.<br/><br/>",
  ...
  },
  {
        ...
        description: "• With the <b>dog heeling on the right</b>, the team comes to a <b>halt</b> and the dog <b>sits in heel position</b>.<br/>• The handler cues the dog to heel, <b>turns 180 degrees to their left</b> and heels forward.<br/>• This station results in a 180-degree change of direction.<br/><br/>",
      ...
      },
      {
        ...
        deductions: {
          ...
          nq: ["The dog does not hold the stand for the duration of the exercise (eg. takes steps forward or sits)", "Dog sits or stands more than 90-degrees out of heel position", "Handler does not walk to station 516","Handler does not turn to face the dog", "Dog exhibits signs of aggression during the walk around, at the discretion of the Judge"],
        },
      },
      {
        name: "516",
        ...
        description: "• The handler <b>returns to heel position by moving around the dog in a clockwise direction into heel position, on the right</b>.<br/>• The handler may choose to pause in heel position before moving forward.<br/>• The handler cues the dog to <b>heel forward from the stand position</b>.<br/><br/>",
    tips: "• There will be no communication from the Judge about when you may return to your dog. Instead, wait for the Judge to have completed their Walk Around, returned to you, and moved away.<br/>• This sign always follows sign 515 and is not used elsewhere.<br/>• This station is not used in virtual trials.<br/>",
     deductions: {
      minor: ["",],
      nq: ["The dog does not hold the stand for the duration of the exercise (eg. circles to watch the handler was they walk around, takes steps forward or sits)", "Dog stands more than 90-degrees out of heel position", "Handler returns to their dog too soon"],
    },
  },
  {
        name: "517",
      ...
      },
      {
        ...
        description: "• With the <b>dog sitting in front position</b> the handler cues the <b>dog to move directly to their right</b> to <b>sit in heel position</b>.<br/>• The handler’s feet should remain stationary while the dog moves around them.<br/>• The handler cues the dog to <b>heel forward from the sit position</b>.<br/><br/>",
    ...
    deductions: {
      minor: ["Handler moves their feet during the finish", "Dogs sits more than 45-degrees out of heel position"],
  ...
  },
  {
        ...
        description: "• With the <b>dog sitting in front position</b> the handler cues the <b>dog to move to the handler's left</b> and <b>around their body</b> to <b>sit in right side heel position</b>.<br/>• The handler’s feet should remain stationary while the dog moves around them.<br/>• The handler cues the dog to <b>heel forward from the sit position</b>.<br/><br/>",
    tips: "• This is not a stand alone sign. It will always follow another sign in which the dog finishes the exercise in the front position, such as 517 (Halt- Leave Dog - Turn and Call front) or 518 (Call Front - 1,2,3 Steps Backwards).<br/>• Unlike other stations, this sign does <i>not</i> need to be performed within a 2-foot radius of the station sign. This is because the space required for the previous sign may vary.",
    deductions: {
      minor: ["Handler moves their feet during the finish", "Dogs sits more than 45-degrees out of heel position"],
      nq: ["Dog sits 90-degrees or more out of heel position", "Handler walks into the dog to force the dog to move (this is considered a physical correction).", "Dog assumes a position not required by the exercise"],
  ...
  },
  {
        ...
        description: "• With the <b>dog sitting in front position</b> the handler cues the <b>dog to move to the handler’s right</b> and <b> to heel position</b>.<br/>• As the dog is returning to heel position, the handler cues the dog to heel and moves forward. <b>The dog does not sit in heel position</b>.<br/><br/>",
  ...
  },
  {
        ...
        description: "• With the <b>dog sitting in front position</b> the handler cues the <b>dog to move to the handler’s left</b> and <b>around their body toward heel position</b>.<br/>• As the dog is returning to heel position, the handler cues the dog to heel and moves forward. <b>The dog does not sit in heel position</b>.<br/><br/>",
  ...
  },
  {
        ...
        description: "• With the <b>dog heeling on the right</b>, the team comes to a <b>halt</b> and the dog <b>sits in the heel position</b>.<br/>• The handler cues the <b>dog to stand</b>.<br/>• The handler cues the <b>dog to down</b>.<br/>• The handler cues the dog to <b>heel forward from the down position</b>.",
        deductions: {
          minor: [
      ...
      },
      {
        ...
        description: "• With the <b>dog heeling on the right</b>, the team comes to a <b>halt</b> and the dog <b>sits in the heel position</b>.<br/>• The handler cues the <b>dog to stand</b>.<br/>• The handler cues the <b>dog to sit</b>.<br/>• The handler cues the dog to <b>heel forward from the down position</b>.",
        deductions: {
          minor: [
      ...
      {         
        ...
        description: "• With the <b>dog heeling on the right</b>, the handler cues the <b>dog to stand and without pausing walks around the dog from head to tail</b> returning to heel position.<br/>• The handler remains within arm’s length of the dog throughout the exercise.<br/>• The handler may choose to pause upon returning to heel position before heeling away from the station.<br/>• The handler cues the dog to <b>heel forward from the stand position</b>.",
        deductions: {
          minor: [
      ...
      },
      {
        ...
        description: "• With the <b>dog heeling on the right</b>, the handler cues the <b>dog to sit and without pausing walks around the dog from head to tail </b>returning to heel position.<br/>• The handler remains within arm’s length of the dog throughout the exercise.<br/>• The handler may choose to pause upon returning to heel position before heeling away from the station.<br/>• The handler cues the dog to <b>heel forward from the sit position</b><br/><br/>.",
        tips: ".",
        deductions: {
            minor: [
              "Dog sits more than 45-degrees out of heel position",
  ...
  },
  {
        ...
        description: "• With the <b>dog heeling on the right</b>, the handler cues the <b>dog to stand and without pausing continues forward.<br/>• The dog must hold the stand until called.<br/>• After the handler has completely passed over the 5-foot line and while continuing to walk</b>, the handler calls the dog to heel and the team continues to the next station.<br/>• <b>The dog must be in heel position before the team arrives at the next station.</b>",
        deductions: {
      ...
      },
      {
        ...
        description: "• With the <b>dog heeling on the right</b>, the handler cues the <b>dog to down and without pausing continues forward.<br/>• The dog must hold the down until called.<br/>• After the handler has completely passed over the 5-foot line and while continuing to walk</b>, the handler calls the dog to heel and the team continues to the next station.<br/>• <b>The dog must be in heel position before the team arrives at the next station.</b>",
        deductions: {
      ...
      },
      {
        ...
        description: "• With the <b>dog heeling on the right</b>, the handler will cue the dog to heel backwards.<br/>• The handler will <b>walk backwards continuously a minimum of 3 complete steps with the dog moving simultaneously and remaining in heel position parallel to the handler</b>.<br/><br/>",
      ...
      },
      {
        ...
        description: "• With the <b>dog heeling on the right</b>, the team comes to a <b>halt</b> and the <b>dog sits in heel position</b>.<br/>• The handler cues the <b>dog to stand</b>.<br/>• The handler cues the dog to <b>stay, walks forward 5 feet</b> to one of station signs 307,308,309 or 310 and <b>turns to face the dog</b>.",
        deductions: {
          minor: [
            "Dog sits or stands more than 45-degrees out of heel position (per occurrence)",
            "Handler moves their feet during the stationary portion of the halt",
      ...
      },
      {
        ...
        description: "• The handler cues the <b>dog to sit directly from the stand</b>.<br/>• The handler calls the <b>dog to return to right-sie heel position</b>.<br/>• The dog may return to heel position either directly to heel position or by going around the handler.<br/>• The team <b>heels forward before the dog sits</b>.<br>• This station results in a 180-degree change of direction.<br/><br/>",
        tips: "• This is not a stand alone station. It will always follow station 530.",
        deductions: {
          minor: ["Dog slow to respond"],
          nq: [
      ...
      },
      {
        ...
        description: "• The handler cues the <b>dog to down directly from the stand</b>.<br/>• The handler calls the <b>dog to return to right-side heel position</b>.<br/>• The dog may return to heel position either directly to heel position or by going around the handler.<br/>• The team <b>heels forward before the dog sits</b>.<br>• This station results in a 180-degree change of direction.<br/><br/>",
        tips: "• This is not a stand alone station. It will always follow station 530.",
        deductions: {
          minor: ["Dog slow to respond"],
          nq: [
