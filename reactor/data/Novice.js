...
const Novice = [
  ...
  },
  {
    ...
    title: "114. 270 Right",
    description:
      "• While heeling, the team <b>makes a 270-degree turn to the right.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/>• This station results in a 90-degree change of direction to the left.<br/><br/>",
  ...
  },
  {
    ...
    title: "115. 270 Left",
    description:
      "• While heeling, the team <b>makes a 270-degree turn to the left.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/>• This station results in a 90-degree change of direction to the right.<br/><br/>",
    tips: "• As a change of direction station, the sign is placed directly on the team's path of travel. The team performs the exercise in front of the sign, then proceeds along the new path.<br/>• 270-degree turns are tight turns, but not pivots. Note the 2 foot maximum diameter of the turn.",
    deductions: {
      minor: [
        "Handler's path while turning more than a 2-foot radius",
  ...
  },
  {
    ...
    title: "116. 360 Right",
    description:
      "• While heeling, the team <b>makes a 360-degree turn to the right.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/><br/>",
  ...
  },
  {
    ...
    title: "117. 360 Left",
    description:
      "• While heeling, the team <b>makes a 360-degree turn to the left.</b><br/>• The handlers’ path while turning should be on or within a diameter of 2 feet.<br/><br/>",
    tips: "• 360-degree turns are tight turns, but not pivots. Note the 2 foot maximum diameter of the turn.<br/>• Perform the turn beside the sign, then continue in the same direction and on the same path of travel",
    deductions: {
      minor: [
        "Handler's path while turning more than a 2-foot radius",
  ...
  },
  {
    ...
    title: "118. Slow Pace",
    description:
      "• While heeling, the team decreases its pace so that there is a <b>noticeable difference in the dogs’ speed from the normal pace.<br/>• The slow pace is maintained continuously until the next station.</b><br/>• This station is followed by either Fast, Normal or the Finish station.</br><br/>",
  ...
  },
  {
    ...
    description:
      "• While heeling, the team moves forward at a <b>normal pace</b> that is comfortable for the dog and handler.<br/>• There must be a <b>noticeable difference in the dogs’ speed from the slow or fast to normal pace.</b><br/><br/>",
