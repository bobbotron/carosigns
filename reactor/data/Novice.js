...
const Novice = [
...
},
  {
    ...
    deductions: {
      ...
      nq: [
        "Dog sits 90 degrees or more out of heel position",
        "Handler takes does not take one full step to the right",
...
},
  {
    ...
    deductions: {
      minor: [
        ...
        "Dog is out of heel position. Forging (mid-point of the dog’s body is past the handler's side), Wide (the dog is more than an arm’s length away from the handlers side) or Lagging (the dog’s nose drops behind the handler’s side)",
      ],
  ...
  },
  {
    ...
    deductions: {
      minor: [
        ...
        "Handler or dog stop forward motion", 
        "Dog is out of heel position. Forging (mid-point of the dog’s body is past the handler's side), Wide (the dog is more than an arm’s length away from the handlers side) or Lagging (the dog’s nose drops behind the handler’s side)",
        "Handlers’ path while turning not within a diameter of 2 feet (deduction not specified in the handbook)", 
